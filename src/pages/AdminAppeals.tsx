...
const bannedPlayers = [
  {
    ...
    category: "Cheater",
    user: "Blake",
    steamUID: "123172817239172893912",
    discordID: "123172817239172893912",
    accountCreated: "09/09/2009 - 09:09 PM",
    reason: "Flying on the map"
  },
  {
    id: "0001",
    category: "Cheater",
    ...
    <div className="flex min-h-screen bg-background">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-card border border-border/40 rounded-lg p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-sm text-muted-foreground mb-1">Total Appeals</p>
                <p className="text-lg font-semibold text-foreground">1,500 Applications</p>
              </div>
            </div>
          </div>

          {/* Total Accepted Appeals */}
          <div className="bg-card border border-border/40 rounded-lg p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-sm text-muted-foreground mb-1">Total Accepted Appeals</p>
                <p className="text-lg font-semibold text-foreground">1,500 Application</p>
              </div>
            </div>
          </div>

          {/* Total Rejected Appeals */}
          <div className="bg-card border border-border/40 rounded-lg p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-sm text-muted-foreground mb-1">Total Rejected Appeals</p>
                <p className="text-lg font-semibold text-foreground">1,500 Application</p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-card border border-border/40 rounded-lg p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-medium text-foreground">List of Banned Players</h3>
                <p className="text-sm text-muted-foreground">1,500 Banned</p>
              </div>
            </div>
          ...
          <div className="space-y-3">
            <div className="grid grid-cols-12 gap-3 text-sm text-muted-foreground pb-3 border-b border-border/40">
              <div className="col-span-1">ID</div>
              <div className="col-span-1">Category</div>
              <div className="col-span-1">User</div>
              <div className="col-span-2">Steam UID</div>
              <div className="col-span-2">Discord ID</div>
              <div className="col-span-2">Account created</div>
              <div className="col-span-1">Reason for ban</div>
              <div className="col-span-1">Actions</div>
              <div className="col-span-1">View</div>
            </div>
            {bannedPlayers.map((player, index) => (
              <div key={index} className="grid grid-cols-12 gap-3 items-center text-sm py-3 border-b border-border/40">
                <div className="col-span-1 text-foreground">{player.id}</div>
                <div className="col-span-1 text-foreground">{player.category}</div>
                <div className="col-span-1 flex items-center gap-2">
                  <div className="w-6 h-6 bg-nodex-red rounded" />
                  <span className="text-foreground">{player.user}</span>
                </div>
                <div className="col-span-2 text-muted-foreground">{player.steamUID}</div>
                <div className="col-span-2 text-muted-foreground">{player.discordID}</div>
                <div className="col-span-2 text-muted-foreground">{player.accountCreated}</div>
                <div className="col-span-1 text-muted-foreground">{player.reason}</div>
        ...
        <DialogContent className="bg-card border-border/40 max-w-md">
          <DialogHeader>
            <div className="flex items-center justify-between">
              <DialogTitle className="text-foreground">Appeal - ID 0001 - User JotapeN</DialogTitle>
          ...
          <div className="space-y-6 pt-4">
            ...
            <div>
              <p className="text-sm text-muted-foreground mb-2">Responses (Selected)</p>
      ...
      <Dialog open={actionsDialogOpen} onOpenChange={setActionsDialogOpen}>
        <DialogContent className="bg-card border-border/40 max-w-3xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <div className="flex items-center justify-between">
              <DialogTitle className="text-foreground">Appeals - ID 0001 - User JotapeN</DialogTitle>
          ...
          <div className="space-y-6 pt-4">
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  <Checkbox id="appeal-check1" defaultChecked className="border-border/40" />
                  <label htmlFor="appeal-check1" className="text-sm text-foreground">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</label>
                </div>
                <div className="flex items-center gap-2">
                  <Checkbox id="appeal-check2" className="border-border/40" />
                  <label htmlFor="appeal-check2" className="text-sm text-foreground">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</label>
                </div>
                <div className="flex items-center gap-2">
                  <Checkbox id="appeal-check3" className="border-border/40" />
                  <label htmlFor="appeal-check3" className="text-sm text-foreground">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</label>
                </div>
                <div className="flex items-center gap-2">
                  <Checkbox id="appeal-check4" className="border-border/40" />
                  <label htmlFor="appeal-check4" className="text-sm text-foreground">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</label>
                </div>
                <div className="flex items-center gap-2">
                  <Checkbox id="appeal-check5" className="border-border/40" />
                  <label htmlFor="appeal-check5" className="text-sm text-foreground">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</label>
                </div>
              </div>
            </div>
